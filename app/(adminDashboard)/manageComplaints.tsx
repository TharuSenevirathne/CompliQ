  ...
  return (
    <View className="flex-1 bg-gray-50">
      <View className="bg-white pt-14 pb-8 px-6 shadow-sm">
        <View className="flex-row items-center justify-between">
          <View>
            ...
            <Text className="text-blue-600 text-base mt-1 font-medium">All user complaints</Text>
          </View>
      ...
      <View className="flex-1 items-center justify-center">
        ...
        <Text className="text-gray-500 mt-4">Complaints management coming soon</Text>
      </View>
    </View>
  )
}
